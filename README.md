...
> Core AI infrastructure engine for model serving and pipeline orchestration - part of the [CortexFramework](https://github.com/CortexFramework) open-source ecosystem.
...
This repository contains the `core` component, which handles the core runtime responsibilities for CortexFramework.
...
```bash
git clone https://github.com/CortexFramework/core
cd core
go mod download
```
...
- **GitHub Issues:** [github.com/CortexFramework/issues](https://github.com/CortexFramework)
- **Discussions:** [github.com/CortexFramework/discussions](https://github.com/CortexFramework)
